...
/*
 * The translation for tl_page.
 */

/*
 * Fields
 */
$GLOBALS['TL_LANG']['tl_page']['faviconConfig'][0]  = 'Webpack Favicon';
$GLOBALS['TL_LANG']['tl_page']['faviconConfig'][1]  = 'Hier können Sie das Webpack Favicon auswählen.';

/*
 * Legends
 */
 $GLOBALS['TL_LANG']['tl_page']['website_fallback_legend'] = 'Website-Einstellungen';
